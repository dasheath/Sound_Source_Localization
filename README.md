...
![TDOA \alpha h(x) = r_1 - r_2 = ||x - a_1|| - ||x - a_2||](https://latex.codecogs.com/svg.image?\bg_white&space;TDOA&space;\alpha&space;h(x)&space;=&space;r_1&space;-&space;r_2&space;=&space;||x-a_1||&space;-&space;||x-a_2||)
